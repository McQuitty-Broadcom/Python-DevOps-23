...
- Your login: is mfwsuser23@demo.broadcom.com
...
- Your userid is CUST023.
- Your password CUST023.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS23 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS23 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST023.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST023.MARBLES.JCL(MARBCOPY)" --vasc`
...
Username: _JENKINSCUST023
Password: Mfuser23@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-23.git`
